...
<Accordion title="Do we have control over what's recommended?" icon="fad fa-question">
...
<Accordion title="Can modifiers be recommended?" icon="fad fa-question">
  No. Recommendations are product-level only; modifiers are never returned.
</Accordion>

<Accordion title="Will it recommend unavailable products?" icon="fad fa-question">
  No. Every suggestion is checked against the live menu and snoozed-product list before it's returned.
</Accordion>

<Accordion title="Are the recommendations genuinely complementary?" icon="fad fa-question">
...
<Accordion title="Is it personalised to the individual customer?" icon="fad fa-question">
...
<Accordion title="Does it account for location, city, region or DMA?" icon="fad fa-question">
...
<Accordion title="Can it recommend something already in the basket?" icon="fad fa-question">
  Unlikely. The engine favours products that complement the basket rather than repeating what's already in it.
</Accordion>

<Accordion title="How long before a new menu product can be recommended?" icon="fad fa-question">
...
<Accordion title="How much order history does the AI need before recommendations are reliable?" icon="fad fa-question">
